...
- `cctx serve` starts the MCP server exposing status, snapshot, ask, history, shell/read cache wrappers, cache paging, report, timeline, metrics, heavy, bloat, diff, and prune tools.
